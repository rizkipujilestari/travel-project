  ...
  <div class="hero_area">
    ...
    <section class=" slider_section position-relative">
      <div class="slider_container">
        <div class="img-box">
          <img src="{{ asset('rent4u/images/hero-img.jpg') }}" alt="">
        </div>
    ...
    <div class="container">
      ...
      <div class="social_container">
        <div class="social-box">
          <div>
            <a href="">
              <img src="{{ asset('rent4u/images/fb.png') }}" alt="">
            </a>
          </div>
          <div>
            <a href="">
              <img src="{{ asset('rent4u/images/twitter.png') }}" alt="">
            </a>
          </div>
          <div>
            <a href="">
              <img src="{{ asset('rent4u/images/linkedin.png') }}" alt="">
            </a>
          </div>
          <div>
            <a href="">
              <img src="{{ asset('rent4u/images/insta.png') }}" alt="">
            </a>
          </div>
        </div>
      </div>
